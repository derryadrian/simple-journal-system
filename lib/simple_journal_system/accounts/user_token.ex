defmodule SimpleJournalSystem.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  schema "users_tokens" do
    ...
    # PERUBAHAN: tambah references: :user_id
    belongs_to :user, SimpleJournalSystem.Accounts.User, references: :user_id
